...
### Acesse o menu callcenter e importe o arquivo callcenter.xml
![alt text](https://github.com/talktelecom/salesforce/blob/master/images/CallCenterConfig.JPG)
...
# 3 - Apos criar a página precisamos configurar o Callcenter com a URL criada
